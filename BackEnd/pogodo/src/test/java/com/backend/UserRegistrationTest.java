...
// This test checks if system fails when trying to register with a username that would  already exists
    ...
    public void testDuplicateUsername() {
        ...
        UserRegistration.storeUser("duplicate_user", "test@example.com", "password123", "Test", "User", "User");
...
public void testInvalidPassword() {
   // Try registering with a password that is too short 
    boolean result = UserRegistration.storeUser("invalid_pass", "invalid@example.com", "short", "Invalid", "Password", "User");
